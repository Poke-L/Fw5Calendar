...
const Questlist = [
	[
		...
		new Quest("", "赤影の衝撃", "Mastodon Jewel", ""),
		new Quest("", "炎王龍の戦慄", "Boarcrest Jewel", ""),
		new Quest("", "幻獣の戦慄", "Crockjaw Jewel", ""),
		new Quest("", "青怪鳥の戦慄", "Eaglewing Jewel", ""),
		new Quest("", "怪鳥の衝撃", "Swallowtail Jewel", ""),
		new Quest("", "装飾品大全・水流の章", "Ursine Jewel", ""),
		...
		new Quest("", "棘茶竜の戦慄", "Turtleshell Jewel", ""),
		new Quest("", "白影の衝撃", "Horsetail Jewel", "")
	],[
		new Quest("", "毒怪鳥の脈動", "Rattail Jewel", ""),
		new Quest("", "黒狼鳥の脈動", "Tigerclaw Jewel", ""),
		new Quest("", "棘竜の脈動", "Chickenwing Jewel", ""),
		new Quest("", "跳緋獣の戦慄", "Rabbitear (Rabittear) Jewel", ""),
		new Quest("", "黒狼鳥の戦慄", "Prowler Jewel", ""),
		new Quest("", "棘竜の衝撃", "Foxtail Jewel", ""),
		new Quest("", "鎌蟹の衝撃", "Rhino Horn Jewel", ""),
		new Quest("", "盾蟹の衝撃", "Whaletide Jewel", ""),
		new Quest("", "潮島への初上陸！", "Sharkjaw Jewel", ""),
		new Quest("", "一角竜の衝撃", "Supple Thread", ""),
		new Quest("", "装飾品大全・氷塊の章", "Squirrel (Tanuki) Jewel", ""),
		new Quest("", "鋼龍の戦慄", "Owl Eye Jewel", ""),
		new Quest("", "霞龍の衝撃", "Stag Antler Jewel", ""),
